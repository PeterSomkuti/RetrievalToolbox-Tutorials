...
The next required object is a location, and for this exercise we opt for an `EarthLocation` type, which describes the position on Earth at which the instrument points.

```{julia}
location = G3RT.EarthLocations(
    16.3713,
    48.2081,
    200.0,
    u"m"
