...
mkdir data
cd data
wget https://github.com/RetrievalToolbox/RetrievalToolbox-Tutorials/blob/main/data/o2_spectroscopy_demo.h5
```
...
```bash
git clone --depth 1 https://github.com/RetrievalToolbox/RetrievalToolbox-Tutorials
